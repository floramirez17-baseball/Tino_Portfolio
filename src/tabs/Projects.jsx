  ...
  return (
    <div style={{ fontFamily: '"Times New Roman", Times, serif', maxWidth: 820, margin: '0 auto' }}>
      <div style={mastheadTop}>
        ...
        <span style={mastheadMeta}>Reviewed by Dr. Andrew Lynch &nbsp;·&nbsp; 2025 &nbsp;·&nbsp; Master's of Science in Finance</span>
      </div>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <DlBtn href="/files/Should AVMs Replace Human Appraisers?.docx">↓ Download Full Paper (.docx)</DlBtn>
      </div>
      ...
      <div style={{ fontSize: 15, lineHeight: 1.85, color: '#1a1a1a' }}>
        ...
        <Section title="Literature Review on Human vs. AVM Performance">
          ...
          <p>A 2025 study from Advances in Consumer Research compares how Zillow's Zestimate AVM performance compares to the seller's listing price of over 300 NYC properties on the MLS. The findings were that Zestimates achieve a lower median absolute percentage error than seller-set list prices (MdAPE ~ 17.5% vs. 19.8%), showing that Zillow's AVM modestly outperforms humans (Jordan & Boeing, 2025). A 2023 Brookings report found that several leading AVMs can estimate home prices within 10 percent of actual sale values for at least 95 percent of properties in tested samples (Brown & Engler, 2023).</p>
        </Section>
        <Section title="Conclusion">
          <p>The trajectory of research, industry practice, and policy guidance in automated valuation shows a real estate ecosystem moving steadily toward deeper automation while confronting the consequences of embedding historical patterns into machine learning systems. This paper stands behind the authors whose work was reviewed by claiming that human intervention should be necessary in the future use of AVMs as official assessment sources. Although the performance of AVMs is proven to outperform humans and the capability of their underlying framework continues to advance, there should be humans utilizing AVMs to check for the appearance of a bias error.</p>
        </Section>
...
function AIBubbleProject() {
  return (
    <div style={{ fontFamily: '"Times New Roman", Times, serif', maxWidth: 820, margin: '0 auto' }}>
      <div style={mastheadTop}>
        <span style={mastheadLabel}>Walton College of Business</span>
        <span style={mastheadMeta}>Financial Data Analytics &nbsp;·&nbsp; Fall 2025 &nbsp;·&nbsp; Master's of Science in Finance</span>
      </div>
      <hr style={mastheadRule} />
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        <div style={{ fontSize: 13, color: '#5C5C5C', marginBottom: 16 }}>
          Financial Data Analytics &nbsp;·&nbsp; Fall 2025
        </div>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 20 }}>
        ...
        <DlBtn href="/files/Is There an AI Bubble?.pptx">↓ Download Presentation (.pptx)</DlBtn>
      </div>
      ...
      <div style={abstractBox}>
        <div style={abstractLabel}>Abstract</div>
        <p style={{ margin: 0, fontSize: 14.5, lineHeight: 1.8, color: '#222' }}>
          This project asks a simple question: are AI stocks in a bubble? To answer it, we analyzed NVIDIA, AMD, TSMC, and Palantir from 2021 through September 2025 — four companies that sit at the center of the AI trade. We compared their returns and volatility against the broader market, looked at how closely they moved with the S&P 500 and Nasdaq, and built a discounted cash flow model to test whether Palantir's stock price could be justified by its fundamentals. Our DCF was cross-checked against estimates from Bank of America, Alpha Spread, and Yahoo Finance. The data shows that NVIDIA and Palantir have significantly outpaced the market and exhibit the kind of erratic, clustered volatility that typically appears in speculative environments. Palantir in particular stands out — its current valuation only makes sense if you assume a level of growth that most analysts consider unrealistic. Our conclusion is that a full market bubble has not formed, but certain AI stocks, especially Palantir, are showing clear signs of speculative excess.
        </p>
      </div>
    ...
    <div>
      ...
      {proj === 'Real Estate Finance Final Project' && (
        <div style={{ fontFamily: '"Times New Roman", Times, serif', maxWidth: 820, margin: '0 auto' }}>
          <div style={mastheadTop}>
            <span style={mastheadLabel}>Walton College of Business</span>
            <span style={mastheadMeta}>Reviewed by Prof. Dale Carlton &nbsp;·&nbsp; 2025 &nbsp;·&nbsp; Master's of Science in Finance</span>
          </div>
          <hr style={mastheadRule} />
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 15, color: '#333', marginBottom: 4 }}>
              <strong>Bryn Taylor, Florentino M. Ramirez IV, Mitchell Kennan, Jason Ferworn, Mason Bennett</strong>
            </div>
            <div style={{ fontSize: 13, color: '#5C5C5C', marginBottom: 16 }}>
              54303 Enterprises, LLC &nbsp;·&nbsp; FINN 54303 &nbsp;·&nbsp; Spring 2025
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 20 }}>
          ...
          <div style={abstractBox}>
            <div style={abstractLabel}>Abstract</div>
            <p style={{ margin: 0, fontSize: 14.5, lineHeight: 1.8, color: '#222' }}>
              This investment pitch presents Marinoni Manor, a proposed value-add multifamily conversion of a 4,946 square-foot commercial office building located at 355 N. College Avenue in Fayetteville, Arkansas. Currently listed at $1.25 million ($252.73/SF) and zoned C-2 Thoroughfare Commercial, the property was previously operated as a residential eight-plex, establishing precedent for a re-zoning or Planned Zoning Development (PZD) application to restore multifamily use. The project is organized as a joint venture under 54303 Enterprises, LLC, with limited partners providing 80% of required equity and the general partner contributing the remaining 20% while managing all operational responsibilities. Total capitalization is projected at $1.35 million, inclusive of $100,000 in targeted renovations, financed at 70% LTV through a 10-year in-house bank loan at 8.5% interest. The property's location — minutes from the University of Arkansas, downtown Fayetteville, and a rapidly expanding high-tech employment corridor — positions it within one of Arkansas' most supply-constrained rental markets, where a documented 10,000-unit housing deficit supports strong long-term rent growth. Base-case projections indicate cash-flow positivity in year one, an after-tax return of 12.4%, and a projected sale at $3.0 million at the end of a 10-year hold. Even under distressed assumptions, investor capital and a partial preferred return are preserved. The analysis concludes that Marinoni Manor represents a compelling, risk-adjusted acquisition opportunity in a high-growth submarket.
            </p>
          </div>
